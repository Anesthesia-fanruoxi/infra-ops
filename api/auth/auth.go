...
func NewHandler(settings *setting.SettingsRepo, sessions *middleware.SessionStore, auditRepo *repo.AuditRepo) *Handler {
	return &Handler{settings: settings, sessions: sessions, auditRepo: auditRepo}
}
...
func (h *Handler) auditLogin(c *gin.Context, action, detail string) {
