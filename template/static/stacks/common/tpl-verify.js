    ...
    <div v-loading="verifying" class="stk-verify-body">
      ...
      <template v-if="verifyTabbed && verifyActiveTab !== 'all'">
        <div class="stk-vf-section">
          <div class="stk-vf-section-title">接入地址 · {{currentVerifyCompLabel}}</div>
          <div class="stk-vf-ep-grid">
            <div class="stk-vf-ep-host-card" v-for="hg in verifyCompEndpointsByHost" :key="hg.host_ip">
              ...
              <div class="stk-vf-ep-host-eps">
                <div class="stk-vf-ep-mini" v-for="ep in hg.endpoints" :key="ep.url">
                  ...
                  <span class="mono stk-vf-ep-mini-url">{{ep.url}}</span>
                  <span class="stk-vf-ep-copy" @click="copyText(ep.url)" title="复制">
            ...
            <div v-if="!verifyCompEndpointsByHost.length" class="stk-vf-empty">该组件暂无接入地址</div>
          </div>
        </div>
      ...
      <template v-else>
        <!-- 接入地址 -->
        <div class="stk-vf-section">
          <div class="stk-vf-section-title">接入地址</div>
          <div class="stk-vf-ep-grid">
            ...
            <div v-if="!verifyEndpointsByHost.length" class="stk-vf-empty">暂无接入地址</div>
          </div>
        </div>
